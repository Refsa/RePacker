...
namespace Refsa.RePacker
{
    public static class PackerExtensions
    {
        ...
        public static void PackValueTuple<T1, T2, T3>(this BoxedBuffer buffer, ref ValueTuple<T1, T2, T3> value)
        {
            RePacker.Pack<T1>(buffer, ref value.Item1);
            RePacker.Pack<T2>(buffer, ref value.Item2);
        ...
        public static void PackValueTuple<T1, T2, T3, T4>(this BoxedBuffer buffer, ref ValueTuple<T1, T2, T3, T4> value)
        {
            RePacker.Pack<T1>(buffer, ref value.Item1);
            RePacker.Pack<T2>(buffer, ref value.Item2);
            RePacker.Pack<T3>(buffer, ref value.Item3);
        ...
        public static void PackValueTuple<T1, T2, T3, T4, T5>(this BoxedBuffer buffer, ref ValueTuple<T1, T2, T3, T4, T5> value)
        {
            RePacker.Pack<T1>(buffer, ref value.Item1);
            RePacker.Pack<T2>(buffer, ref value.Item2);
            RePacker.Pack<T3>(buffer, ref value.Item3);
        ...
        public static void PackValueTuple<T1, T2, T3, T4, T5, T6>(this BoxedBuffer buffer, ref ValueTuple<T1, T2, T3, T4, T5, T6> value)
        {
            RePacker.Pack<T1>(buffer, ref value.Item1);
            RePacker.Pack<T2>(buffer, ref value.Item2);
            RePacker.Pack<T3>(buffer, ref value.Item3);
        ...
        public static void UnpackValueTuple<T1, T2, T3>(this BoxedBuffer buffer, out ValueTuple<T1, T2, T3> value)
        {
            value = new ValueTuple<T1, T2, T3>(RePacker.Unpack<T1>(buffer), RePacker.Unpack<T2>(buffer), RePacker.Unpack<T3>(buffer));
        }

        public static void UnpackValueTuple<T1, T2, T3, T4>(this BoxedBuffer buffer, out ValueTuple<T1, T2, T3, T4> value)
        {
            value = new ValueTuple<T1, T2, T3, T4>(RePacker.Unpack<T1>(buffer), RePacker.Unpack<T2>(buffer), RePacker.Unpack<T3>(buffer), RePacker.Unpack<T4>(buffer));
        }

        public static void UnpackValueTuple<T1, T2, T3, T4, T5>(this BoxedBuffer buffer, out ValueTuple<T1, T2, T3, T4, T5> value)
        {
            value = new ValueTuple<T1, T2, T3, T4, T5>(RePacker.Unpack<T1>(buffer), RePacker.Unpack<T2>(buffer), RePacker.Unpack<T3>(buffer), RePacker.Unpack<T4>(buffer), RePacker.Unpack<T5>(buffer));
        }

        public static void UnpackValueTuple<T1, T2, T3, T4, T5, T6>(this BoxedBuffer buffer, out ValueTuple<T1, T2, T3, T4, T5, T6> value)
        {
            value = new ValueTuple<T1, T2, T3, T4, T5, T6>(RePacker.Unpack<T1>(buffer), RePacker.Unpack<T2>(buffer), RePacker.Unpack<T3>(buffer), RePacker.Unpack<T4>(buffer), RePacker.Unpack<T5>(buffer), RePacker.Unpack<T6>(buffer));
        }
    }
