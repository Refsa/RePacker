...
namespace Refsa.RePacker
{
    ...
    public class ValueTupleWrapper<T1, T2> : RePackerWrapper<ValueTuple<T1, T2>>
    {
    ...
    public class ValueTupleWrapper<T1, T2, T3> : RePackerWrapper<ValueTuple<T1, T2, T3>>
    {
    ...
    public class ValueTupleWrapper<T1, T2, T3, T4> : RePackerWrapper<ValueTuple<T1, T2, T3, T4>>
    {
    ...
    public class ValueTupleWrapper<T1, T2, T3, T4, T5> : RePackerWrapper<ValueTuple<T1, T2, T3, T4, T5>>
    {
    ...
    public class ValueTupleWrapper<T1, T2, T3, T4, T5, T6> : RePackerWrapper<ValueTuple<T1, T2, T3, T4, T5, T6>>
    {
