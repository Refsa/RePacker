...
namespace RePacker.Builder
{
    internal class KeyValuePairPacker<T1, T2> : RePackerWrapper<KeyValuePair<T1, T2>>
    {
        ...
        public override void Pack(Buffer buffer, ref KeyValuePair<T1, T2> value)
        {
            buffer.PackKeyValuePair(ref value);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override void Unpack(Buffer buffer, out KeyValuePair<T1, T2> value)
        {
            buffer.UnpackKeyValuePair<T1, T2>(out value);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override void UnpackInto(Buffer buffer, ref KeyValuePair<T1, T2> value)
        {
            buffer.UnpackKeyValuePair<T1, T2>(out value);
        }
